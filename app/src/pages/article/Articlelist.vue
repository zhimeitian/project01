  ...
  methods: {
    ...
    pubArticleFn(state) {
      ...
      this.$refs.pubFormRef.validate(async valid => {
        ...
        // 4. TODO：发布文章
        // 创建 FormData 对象，专门用来装文件内容的容器
        const fd = new FormData();

        // 向 FormData 中追加数据，fd.append('参数名',值)
